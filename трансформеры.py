...
df = pd.read_csv('/Users/anastasiabelaeva/Desktop/Postgraduate/данные/CT/экономыш 2023/preprocessed.csv')
df['target'] = "a"
df.at[4, 'target'] = 'b'
df_target = df['target']
...
train_size = 0.81
train_df = df.sample(frac=train_size, random_state=5).reset_index(drop=True)
...
class RUClass(torch.nn.Module):
    def __init__(self):
        ...
        self.ru_model = AutoModel.from_pretrained("ai-forever/sbert_large_mt_nlu_ru", return_dict=True)
